...
Функционал:Creative Integrator
  ...
  @negative-create-task
  Сценарий: Пользователь создает задачу с невалидным временным промежутком
    Когда Пользователь создает задачу с параметрами
      | Название         | Написание автотестов на трекер       |
      | Время начала     | 00:20                                |
      | Время конец      | 00:30                                |
  ...
  @negative-create-task
  Сценарий: Пользователь создает задачу за вчерашний день
    Когда Пользователь создает задачу за вчерашний день редактирует ее и сохраняет
      | Название         | Написание автотестов для проекта     |
      | Время начала     | 08:31                                |
      | Время конец      | 08:40                                |
      | Проект           | Песок                                |
      | Ссылка на задачу | https://hub.crtweb.ru/tracker        |
