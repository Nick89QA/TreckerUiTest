...
# Тест проходит корректно
  ...
  Сценарий: Пользователь создает проект без полных данных
    ...
    Тогда Пользователю приходит уведомление о необходимости заполнить все поля
  ...
  Сценарий: Пользователь проверяет работу пагинации на странице
    ...
    Тогда при каждом клике на пагинацию страница на которой находится ползователь обновляется
