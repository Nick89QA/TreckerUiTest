...
# Тест проходит корректно
  ...
  Сценарий: Пользователь просматривает информацию по проектах за вчерашний день
  ...
  Сценарий: Пользователь просматривает информацию по проектах за текущую неделю
    Когда Пользователь переходит на страницу Профиль и в календаре просматривает информацию по проектам за текущую неделю
    Тогда Пользователь убеждается об отсутствии отчета за данный период

  Сценарий: Пользователь просматривает информацию за прошлую неделю
    Когда Пользователь переходит на страницу Профиль и в календаре просматривает информацию по проектам за прошлую неделю
    Тогда Пользователь видит информацию по проектам за прошлую неделю

  Сценарий: Пользователь просматривает информацию по проектам за текущий месяц
    Когда Пользователь переходит на страницу Профиль и в календаре просматривает информацию по проектам за текущий месяц
    Тогда Пользователь видит информацию по проектам за текущий месяц

  Сценарий: Пользователь просматривает информацию по проекту за прошлую неделю
    Когда Пользователь заходит на страницу Профиль и смотрит информацию по конкретному проекту за прошлую неделю
    Тогда Пользователь видит информацию по проекту за прошлую неделю

  Сценарий: Пользователь просматривает информацию по проекту за прошлый месяц
    Когда Пользователь заходит на страницу Профиль и смотрит информацию по конкретному проекту за прошлый месяц
